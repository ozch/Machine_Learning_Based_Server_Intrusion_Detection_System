...
# How to Run
  ...
  <p>4. All files start with nsl.*.py are model retraining,this program automactically collects and labels data for improve model (self_learning) with admin feedback run those to calliberate model according to your network(require atleast 6 days of training), you can automate this process(but i'm done for now)</p>
